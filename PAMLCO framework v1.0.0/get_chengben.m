function [eur, eurfracture, f] = NPV0719(x, jingzuobiao_pingtai_hebing, jingchang_hebing, pingtaizuobiao_hebing)
...
eurfracture=EURfracture(x, ZA);
eur = EUR12(x);
f=eur-eurfracture-5000000;
% f=EUR12(x)-EURfracture(x, ZA)-5000000;
end