function [pingtai_chengben] = get_zuanjingchengben(jingzuobiao_pingtai_hebing, jingchang_hebing, pingtaizuobiao_hebing, x_za, y_za, value_za, x_dengzhixian, y_dengzhixian, value_dengzhixian) % A靶点坐标，井长，平台坐标
...
pingtai_chengben = sum(jing_chengben);
