function [f] = get_lirun(x, jingzuobiao_pingtai_hebing, jingchang_hebing, pingtaizuobiao_hebing, x_za, y_za, value_za, x_dengzhixian, y_dengzhixian, value_dengzhixian)
