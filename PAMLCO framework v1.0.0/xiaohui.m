...
for ceng=1:max(flag_ceng_zong)
    ...
    for zdx=1:jingshu
        ...
        result_npv(zdx) = NPV0719([POR_mean, PERM_mean, SG_mean, zuiyou_banchang(zdx), liefengjianju, zuiyou_jingchang_reshape(zdx), daoliunengli], [jing_zuobiao(zdx, 1), jing_zuobiao(zdx, 2)], zuiyou_jingchang_reshape(zdx), pingtai_zuobiao(lianjie_flag(zdx), :));
    end
